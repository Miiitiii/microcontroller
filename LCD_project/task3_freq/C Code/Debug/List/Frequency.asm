...
;NAME DEFINITIONS FOR GLOBAL VARIABLES ALLOCATED TO REGISTERS
	.DEF _riseStartEdge=R4
	.DEF _riseStartEdge_msb=R5
	.DEF _fallStartEdge=R6
	.DEF _fallStartEdge_msb=R7
	.DEF _riseEndEdge=R8
	.DEF _riseEndEdge_msb=R9
	.DEF _period=R10
	.DEF _period_msb=R11
	.DEF __lcd_x=R13
	.DEF __lcd_y=R12
...
_0x0:
	.DB  0x46,0x72,0x65,0x71,0x3A,0x20,0x25,0x64
	.DB  0x20,0x48,0x7A,0x0,0x57,0x61,0x69,0x74
...
; 0000 004A             sprintf(frequency,"Freq: %d Hz", (int)freq);
	LDI  R30,LOW(_frequency)
	LDI  R31,HIGH(_frequency)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
	ST   -Y,R31
...
; 0000 004D 			lcd_puts(frequency);
	LDI  R26,LOW(_frequency)
	LDI  R27,HIGH(_frequency)
	RJMP _0x13
